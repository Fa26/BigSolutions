...
public class UsuarioBean implements Serializable {
    ...
    public void validacionCorreo() {
        ...
        props.put("mail.smtp.host", "localhost"); //el servidor  donde manda los correo
        props.put("mail.smtp.port", "587");//puerto donde se conecta

        Session session = Session.getInstance(props,
            new javax.mail.Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
            return new PasswordAuthentication("", "");//la primera cadena es usuario  y la segunda contraseña
            }
        });
        ...
        try {
            ...
            message.setFrom(new InternetAddress("alguien@gmail.com"));//remitente el que lo manda
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse("to-email@gmail.com"));//destinatrio de el correo
